		...
		$manager->add_section(
			new Software_Company_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/products/software-wordpress-theme',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Software_Company_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/theme-documentation/software-company-elementor/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Software_Company_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://preview.wpelemento.com/software-company-elementor/',
					'priority'    => 5,
				)
			)
		);
